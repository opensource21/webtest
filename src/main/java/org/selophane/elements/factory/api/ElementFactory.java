...
public final class ElementFactory {
    ...
    /**
     * See {@link
     * org.openqa.selenium.support.PageFactory#initElements(org.openqa.selenium.
    ...
    public static <T> T initElements(WebDriver webDriver, T page) {
        initElements(new ElementDecorator(webDriver,
                new DefaultElementLocatorFactory(webDriver)), page);
        return page;
    }
